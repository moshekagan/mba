...
churn_training_df = pd.read_csv('/content/drive/MyDrive/python_course/Data/churn_training.csv')
...
# KNN_pred = KNN_model.predict(X_value_normalized)
# cm = confusion_matrix(y_value, KNN_pred)
# tn, fp, fn, tp = confusion_matrix(y_value, KNN_pred).ravel()
# accuracy = accuracy_score(y_value, KNN_pred)
# recall = recall_score(y_value, KNN_pred)
# precision = precision_score(y_value, KNN_pred)
# 
...
churn_holdout_df = pd.read_csv('/content/drive/MyDrive/python_course/Data/churn_holdout.csv')
